...
- **Enter-to-submit search** — Typing does nothing until Enter is pressed. First Enter submits the query; subsequent Enters cycle through matches. "No matches found" shown when no lines match.
